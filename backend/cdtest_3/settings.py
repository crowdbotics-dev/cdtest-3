"""
Django settings for cdtest_3 project.
...
WSGI_APPLICATION = 'cdtest_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cdtest_3 API",
    "DESCRIPTION": "API documentation for cdtest_3 App",
    "VERSION": "v1",
}
